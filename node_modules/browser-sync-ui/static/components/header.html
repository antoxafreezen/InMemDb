<header bs-header role="banner">
    ...
    <aside bs-controls="top">
        <div bs-flex="top">
            ...
            <a href="{{app.options.port | localRootUrl:app.options.database}}" target="_blank" bs-control title="Open a new tab" ng-if="app.options" ng-show="app.options.mode !== 'snippet'" class="ng-scope">
