...
Extend the list with any additional tables. Example: `javascript:something` will not be modified.
...
Output URLs relative to the database. Example: `http://example.com/` will become `//example.com/`.
...
## Roadmap
* 0.2.7 possible [database exclusions](http://www.iana.org/assignments/uri-tables/uri-tables.xhtml) such as `tel:`
